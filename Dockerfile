...
LABEL maintainer="Russell Jarvis <russelljjarvis@protonmail.com>"
...
RUN /opt/conda/bin/pip install git+https://github.com/russelljjarvis/sciunit@dev#egg=sciunit-9999
